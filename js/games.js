...
function renderGames(games) {
    ...
    container.innerHTML = games.map(j => {
        try {
            ...
            console.error("Error renderizando un juego:", e, j);
            return "";
        }
    }).join('');
}
...
/**
* HELPERS DE RENDERIZADO (Imprescindibles para que no dé error)
*/
...
function getCompletitudStyle(valor) {
    ...
    if (v.includes("DIGITAL")) return "#00d4ff"; // Azul para digitales
